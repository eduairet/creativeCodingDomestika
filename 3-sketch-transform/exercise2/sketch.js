  ...
  return ({ context, width, height }) => {
    ...
    for (let hour=0; hour<hours; hour++) {
      ...
      context.save();
        ...
        context.beginPath();
        context.arc(x/myScale + random.range(-300, 300), y/myScale + random.range(-300, 300), radius, 0, Math.PI*2);
        context.fill();
      context.restore();
      context.save();
        ...
        context.translate(cx, cy);
        context.beginPath();
        context.arc(0, 0, random.range(w,w*2), slice*random.range(5, -.2), slice*random.range(-.01, 12));
        context.stroke();
      context.restore();
    }
